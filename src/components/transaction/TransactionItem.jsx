...
function TransactionItem({ transaction: tx, onClick, onVerify }) {
  ...
  return (
    <div
      ...
      className="flex items-center justify-between p-3 rounded-lg bg-bg dark:bg-[#000000] hover:bg-bg-secondary dark:hover:bg-[#0A0A0A] cursor-pointer transition-colors duration-150"
    >
